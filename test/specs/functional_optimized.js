        ...
        describe('Instantiation of a simple vanilla inheritance setup', function () {
            ...
            Andre = Class.declare(Person, function ($super) {
                return {
                    $name: 'André',
                    getName: function () {
                        return 'André ' + $super.getName.call(this);
                    }
                };
            }, true);
            ...
            Mario = Class.declare(Person, function ($super) {
                return {
                    initialize: function () {
                        $super.initialize.call(this);
                    }
            ...
            Helena = Class.declare(Person2, function ($super) {
                return {
                    initialize: function () {
                        $super.initialize.call(this);
                        this._name = 'Ribau';
        ...
        if (/strict/.test(global.build) && (Object.seal || Object.freeze)) {
            ...
            describe('$locked', function () {
                ...
                it('should read the default value', function () {
                    ...
                    OtherClass = Class.declare(function () { return {}; }, true);
                ...
                it('should be inherited and once unlocked it can\'t be locked', function () {
                    ...
                    var SomeClass = function () {},
                        OtherClass = Class.declare(function () { return { $locked: false }; }, true),
                        SomeSubClass,
                        OtherSubClass,
                        someSubClass,
                        otherSubClass;
                    ...
                    SomeSubClass = Class.declare(function () { return { $extends: SomeClass }; }, true);
                    OtherSubClass = Class.declare(function () { return { $extends: OtherClass }; }, true);
